 ...
 * that has been modified to make use of methods in 
 * RPITechSuppCamViewer to handle calls timing out.
 * Note: this version has been further modified to disable
 * ending calls due to timeout due to issues with Raspberry Pi
